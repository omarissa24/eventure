...
export default {
  ...
  project: {
    link: "https://github.com/omarissa24/eventure",
  },
  head: (
    <>
      <meta name='viewport' content='width=device-width, initial-scale=1.0' />
      <meta property='og:title' content='Eventure' />
      <meta property='og:description' content='Eventure Documentation' />
    </>
  ),
  banner: {
    key: "1.0-release",
    text: (
      <a href='https://eventure-rho.vercel.app/' target='_blank'>
        🎉 Eventure 1.0 is released. Read more →
      </a>
    ),
  },
};
